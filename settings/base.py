...
SECRET_KEY = 'n@u*2g8%=9t$vf1hp$ieis)%ww0u96__q2q#gj!1!#emty66e4'
...
SQLALCHEMY_DATABASE_URI = 'postgres://anthill_environment@/anthill_environment'

LOCATION = 'http://localhost:9617'
BROKER = 'amqp://guest:guest@localhost:5672'

# ROUTES_CONF = 'environment.routes'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'anthill.server': {
            ...
            'filename': os.path.join(LOGGING_ROOT_DIR, 'environment.log'),
            'formatter': 'anthill.server',
...
GRAPHENE = {
    'SCHEMA': 'environment.api.v1.public.schema',
    'MIDDLEWARE': ()
}
